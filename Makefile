...
SRC:=$(GOPATH)/src/github.com/izaiasemjr/reporter
...
.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/izaiasemjr/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t izaiasemjr/grafana-reporter:2.3.0 -t izaiasemjr/grafana-reporter:latest .

docker-push:
	@docker push izaiasemjr/grafana-reporter
